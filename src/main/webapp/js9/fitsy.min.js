...
Fitsy.getDataSlice=function(b,a,d,e,c,f){var g,j,k,p,h,m,q,n=Array.prototype.slice.call(arguments,6);switch(b.ftype){case "file":c&&(b.read.onloadend=function(){b.result="asString"===a?Fitsy.getBinaryString(b.read.result):b.read.result;c.apply(null,n)});f&&(b.read.onerror=function(){f.apply(null,n)});g=d||e?Fitsy.getFileSlice(b.file,d,e):b.file;b.read.readAsArrayBuffer(g);break;case "array":"asString"===a?(g=d||e?b.file.slice(d,e):b.file,b.result=Fitsy.getBinaryString(g)):(b.result=b.file,d&&e?(b.rlo=
d,b.rhi=e):(delete b.rlo,delete b.rhi));c&&c.apply(null,n);break;case "gzarray":d!==b.gz.here&&(Astroem.gzseek(b.gz.fd,d,0),b.gz.here=d);j=e-d;try{g=new Uint8Array(j)}catch(l){Fitsy.error("can't allocate enough memory to slice this FITS file",l)}k=Math.min(j,Fitsy.options.gzheapsize);m=Module._malloc(k);q=new Uint8Array(Module.HEAPU8.buffer,m,k);h=j;for(j=0;h;)p=Math.min(h,k),p=Astroem.gzread(b.gz.fd,q.byteOffset,p),0<p?(Fitsy.memcpy(g.buffer,j,Module.HEAPU8.buffer,m,p),j+=p,h-=p):h=0;Module._free(q.byteOffset);
...
Fitsy.readImageHDUDataConverter=function(b,a,d,e){var c,f,g,j,k,p;g=0;var h;a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;a.filename=b.name;switch(b.ftype){case "array":b.rlo&&(g=b.rlo)}try{switch(a.bitpix){case 8:c=DataView.prototype.getUint8;f=DataView.prototype.setUint8;a.filedata=new Uint8Array(b.result,g);break;case -16:c=DataView.prototype.getUint16;f=DataView.prototype.setUint16;a.filedata=new Uint16Array(b.result,g);break;case 16:a.bzero&&32768===a.bzero?(c=DataView.prototype.getUint16,
f=DataView.prototype.setUint16,a.filedata=new Uint16Array(b.result,g),a.bitpix=-16):(c=DataView.prototype.getInt16,f=DataView.prototype.setInt16,a.filedata=new Int16Array(b.result,g));break;case 32:c=DataView.prototype.getInt32;f=DataView.prototype.setInt32;a.filedata=new Int32Array(b.result,g);break;case -32:c=DataView.prototype.getFloat32;f=DataView.prototype.setFloat32;a.filedata=new Float32Array(b.result,g);break;case -64:c=DataView.prototype.getFloat64,f=DataView.prototype.setFloat64,a.filedata=
new Float64Array(b.result,g)}}catch(m){Fitsy.error("can't allocate enough memory for this FITS image",m)}a.image=a.filedata;p=a.bzero||0;b=new DataView(b.result);h=a.converted?Fitsy.hostEndian:!1;j=0;for(k=g;j<a.datapixls;j++,k+=a.pixlbytes)g=c.call(b,k,h)+p,isNaN(g)||(a.dmin=Math.min(a.dmin,g),a.dmax=Math.max(a.dmax,g)),a.converted||f.call(b,k,g,Fitsy.hostEndian);a.converted=!0;e(a,d)};
Fitsy.readImageHDUData=function(b,a,d,e){Fitsy.getDataSlice(b,"asArray",a.dataseek,a.dataseek+2880*a.databloks,Fitsy.readImageHDUDataConverter,Fitsy.readError,b,a,d,e)};
...
Fitsy.readTableHDUDataBinner=function(b,a,d,e,c){var f,g,j,k="true",p=0,h=e.table||Fitsy.options.table;if(!a.nev){a.filename=b.name;if(a.image&&a.image.length>=h.nx*h.ny)for(f=0;f<a.image.length;f++)a.image[f]=0;else a.image=new Int32Array(h.nx*h.ny);a.data=a.image;a.head=Fitsy.clone(a.filehead);a.card=Fitsy.clone(a.filecard);for(f=0;f<h.xcol.length&&void 0===a.table[h.xcol[f]];f++);a.colx=a.table[h.xcol[f]];for(f=0;f<h.ycol.length&&void 0===a.table[h.ycol[f]];f++);a.coly=a.table[h.ycol[f]]}a.filedata=
b.result;var m=a.colx,q=a.coly,n={nx:h.nx,ny:h.ny,width:h.nx,data:a.image},l={x:{type:m.type,offs:m.offs,min:Number(m.min),range:m.max-m.min+1},y:{type:q.type,offs:q.offs,min:Number(q.min),range:q.max-q.min+1},cx:h.cx,cy:h.cy,width:a.width,length:a.length,bin:h.bin,filter:h.filter};void 0===l.cx&&(l.cx=(m.max-m.min+1)/2);void 0===l.cy&&(l.cy=(q.max-q.min+1)/2);f={table:l,image:n,BinText:1===l.bin?"":"/"+Number(l.bin)};l.filter&&(j=Fitsy.tableFilter(a,l.filter),k=Fitsy.template(j,f));f.FilterText=
k;k=Fitsy.template(Fitsy.BinTableTemplate,f);try{g=(new Function(k))()}catch(r){Fitsy.error("An error occurred while generating the filter/binning function. Please check the filter syntax: "+l.filter)}a.view=new DataView(a.filedata);switch(b.ftype){case "array":b.rlo&&(p=b.rlo)}try{g(a.view,p,n,d)}catch(s){j?Fitsy.error("An error occurred while binning the table. Please check the filter syntax: "+j):Fitsy.error("An unknown error occurred while binning the table")}a.nev+=d;if(a.nev===a.length){a.table.bin=
h.bin;a.table.filter=h.filter;a.table.nx=h.nx;a.table.ny=h.ny;a.table.cx=l.cx;a.table.cy=l.cy;a.dmin=Number.MAX_VALUE;a.dmax=Number.MIN_VALUE;for(f=0;f<n.nx*n.ny;f++)a.dmin=Math.min(a.dmin,a.data[f]),a.dmax=Math.max(a.dmax,a.data[f]);a.axis[1]=n.nx;a.axis[2]=n.ny;a.head.NAXIS1=n.nx;a.head.NAXIS2=n.ny;a.card[0]=Fitsy.cardfmt("SIMPLE",0,!0,"Standard FITS Image");a.card[Fitsy.cardfind(a.card,"BITPIX",0)]=Fitsy.cardfmt("BITPIX",0,32,"FITS Data type.");a.card[Fitsy.cardfind(a.card,"NAXIS",0)]=Fitsy.cardfmt("NAXIS",
0,2,"Number of Axes");a.card[Fitsy.cardfind(a.card,"NAXIS1",1)]=Fitsy.cardfmt("NAXIS1",0,n.nx,"Axis Dimension");a.card[Fitsy.cardfind(a.card,"NAXIS2",1)]=Fitsy.cardfmt("NAXIS2",0,n.ny,"Axis Dimension");f=m.ith;Fitsy.cardcopy(a,"TCTYP"+f,a,"CTYPE1");Fitsy.cardcopy(a,"TCRVL"+f,a,"CRVAL1");Fitsy.cardcopy(a,"TCDLT"+f,a,"CDELT1",void 0,function(a){return a*l.bin});Fitsy.cardcopy(a,"TCRPX"+f,a,"CRPIX1",void 0,function(a){return(a-l.x.min)/l.bin+1});Fitsy.cardcopy(a,"TCROT"+f,a,"CROTA1");f=q.ith;Fitsy.cardcopy(a,
"TCTYP"+f,a,"CTYPE2");Fitsy.cardcopy(a,"TCRVL"+f,a,"CRVAL2");Fitsy.cardcopy(a,"TCDLT"+f,a,"CDELT2",void 0,function(a){return a*l.bin});Fitsy.cardcopy(a,"TCRPX"+f,a,"CRPIX2",void 0,function(a){return(a-l.y.min)/l.bin+1});Fitsy.cardcopy(a,"TCROT"+f,a,"CROTA2");Fitsy.cardcopy(a,"LTV1",a,"LTV1",0,function(){return n.nx/2-a.table.cx/l.bin});Fitsy.cardcopy(a,"LTV2",a,"LTV2",0,function(){return n.ny/2-a.table.cy/l.bin});Fitsy.cardcopy(a,"LTM1_1",a,"LTM1_1",1,function(a){return a/l.bin});Fitsy.cardcopy(a,
"LTM1_2",a,"LTM1_2",0,function(a){return a/l.bin});Fitsy.cardcopy(a,"LTM2_1",a,"LTM2_1",0,function(a){return a/l.bin});Fitsy.cardcopy(a,"LTM2_2",a,"LTM2_2",1,function(a){return a/l.bin});c(a,e)}else d=Math.min(a.length-a.nev,Fitsy.options.maxev),g=a.dataseek+a.nev*a.width,Fitsy.getDataSlice(b,"asArray",g,g+d*a.width,Fitsy.readTableHDUDataBinner,Fitsy.readError,b,a,d,e,c)};
...
Fitsy.fetchURL=function(b,a,d,e){var c=new XMLHttpRequest;void 0===a&&(a=b,b=/([^\\\/]+)$/.exec(a)[1]);d=d||Fitsy.options;c.open("GET",a,!0);c.responseType="blob";c.onload=function(){var f;c.xtimeout&&(clearTimeout(c.xtimeout),delete c.xtimeout);4===this.readyState&&(200===this.status||0===this.status?(f=new Blob([this.response]),f.name=b,d.messages&&d.messages(""),Fitsy.onFile([f],d,e)):404===this.status?Fitsy.error("could not find "+a):Fitsy.error("can't load "+a+" ("+this.status+")"))};d.messages&&
(c.addEventListener("progress",function(a){d.messages("progress "+a.loaded.toString())}),c.addEventListener("error",function(){d.messages("error loading FITS file")}),c.addEventListener("abort",function(){d.messages("abort while loading FITS file")}));try{c.send()}catch(f){Fitsy.error("request to load "+a+" failed",f)}c.xtimeout=setTimeout(function(){Fitsy.error("timeout while waiting for response from server; "+a+" might not exist")},Fitsy.options.xtimeout)};
Fitsy.handleImageFile=function(b,a,d){void 0===a&&(a=Fitsy.options);void 0===d&&(d=Fitsy.handler);var e=new FileReader;e.onload=function(c){var f=new Image;f.src=c.target.result;f.onload=function(){var c,e,k=0,p;c=document.createElement("canvas");e=c.getContext("2d");var h=f.height,m=f.width;c.width=m;c.height=h;e.drawImage(f,0,0);var q=e.getImageData(0,0,m,h).data,n=new Float32Array(h*m);for(e=0;e<h;e++)for(c=0;c<m;c++)p=0.299*q[k]+0.587*q[k+1]+0.114*q[k+2],n[(h-e)*m+c]=p,k+=4;c={head:{},name:b.name,
filedata:n,image:n,naxis:2,axis:[0,m,h],bitpix:-32};c.dmin=Number.MAX_VALUE;c.dmax=Number.MIN_VALUE;for(k=0;k<h*m;k++)c.dmin=Math.min(c.dmin,c.image[k]),c.dmax=Math.max(c.dmax,c.image[k]);d(c,a)}};e.readAsDataURL(b)};
